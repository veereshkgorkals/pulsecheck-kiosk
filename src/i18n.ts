...
export const translations = {
  en: {
    ...
    queueTokenNumber: 'YOUR QUEUE TOKEN NUMBER',
    ...
    scheduleConfirmed: 'Schedule Confirmed & Sent to Doctor',
    patientContact: 'Patient Contact',
    estimatedWaitTime: 'Estimated Wait Time',
    instructionsText: "Your intake notes and clinical priority have been transmitted directly to Dr. {doctorName}'s active queue. Please wait in the OPD lounge until Token {tokenNumber} is called.",
    receiveTicketSms: 'Receive Ticket on SMS / WhatsApp',
    copyDetails: 'Copy Appointment Details',
    copied: 'Copied!',
    smsDispatched: 'SMS dispatched to',
    hospitalDispatch: 'Hospital Dispatch • Just now',
  },
  es: {
    ...
    queueTokenNumber: 'SU NÚMERO DE TURNO',
    ...
    scheduleConfirmed: 'Horario Confirmado y Enviado al Médico',
    patientContact: 'Contacto del Paciente',
    estimatedWaitTime: 'Tiempo de Espera Estimado',
    instructionsText: "Sus notas de admisión y prioridad clínica han sido transmitidas directamente a la cola activa del Dr. {doctorName}. Por favor, espere en la sala de OPD hasta que se llame al Turno {tokenNumber}.",
    receiveTicketSms: 'Recibir Turno por SMS / WhatsApp',
    copyDetails: 'Copiar Detalles de la Cita',
    copied: '¡Copiado!',
    smsDispatched: 'SMS enviado a',
    hospitalDispatch: 'Despacho del Hospital • Justo ahora',
  },
  hi: {
    ...
    queueTokenNumber: 'आपका कतार टोकन नंबर',
    ...
    scheduleConfirmed: 'शेड्यूल की पुष्टि की गई और डॉक्टर को भेजा गया',
    patientContact: 'रोगी संपर्क',
    estimatedWaitTime: 'अनुमानित प्रतीक्षा समय',
    instructionsText: "आपके नोट्स और क्लिनिकल प्राथमिकता सीधे डॉ. {doctorName} को भेज दी गई है। कृपया ओपीडी लाउंज में प्रतीक्षा करें जब तक टोकन {tokenNumber} को बुलाया न जाए।",
    receiveTicketSms: 'SMS / WhatsApp पर टोकन प्राप्त करें',
    copyDetails: 'अपॉइंटमेंट विवरण कॉपी करें',
    copied: 'कॉपी किया गया!',
    smsDispatched: 'SMS भेजा गया',
    hospitalDispatch: 'अस्पताल प्रेषण • अभी',
  },
  zh: {
    ...
    originalTranscript: '原始文字记录',
    requiredErr: '请填写所有必填字段。',
    queueTokenNumber: '您的排队号码',
    estimatedWait: '排队状态:',
    ...
    scheduleConfirmed: '预约已确认并发送给医生',
    patientContact: '患者联系方式',
    estimatedWaitTime: '预计等待时间',
    instructionsText: "您的就诊记录和临床优先级已直接发送到 {doctorName} 医生的当前队列中。请在门诊休息室等候，直到呼叫您的排队号码 {tokenNumber}。",
    receiveTicketSms: '通过 SMS / WhatsApp 接收排队号码',
    copyDetails: '复制预约详情',
    copied: '已复制！',
    smsDispatched: '短信已发送至',
    hospitalDispatch: '医院调度 • 刚刚',
  },
  fr: {
    ...
    queueTokenNumber: 'VOTRE NUMÉRO DE TICKET',
    ...
    scheduleConfirmed: 'Rendez-vous Confirmé et Envoyé au Médecin',
    patientContact: 'Contact du Patient',
    estimatedWaitTime: 'Temps d\'Attente Estimé',
    instructionsText: "Vos notes d'admission et votre priorité clinique ont été transmises directement à la file d'attente du Dr. {doctorName}. Veuillez patienter dans le salon OPD jusqu'à ce que le numéro {tokenNumber} soit appelé.",
    receiveTicketSms: 'Recevoir le Ticket par SMS / WhatsApp',
    copyDetails: 'Copier les Détails du Rendez-vous',
    copied: 'Copié !',
    smsDispatched: 'SMS envoyé à',
    hospitalDispatch: 'Répartition de l\'Hôpital • À l\'instant',
  }
};
